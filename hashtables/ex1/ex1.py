...
def get_indices_of_item_weights(weights, length, limit):
    # create a dictionary
    # create a variable checking if the other wanted item is in the dictionary
    # run a loop for the length
        # if variable is true return the iteration of the loop and the value of the weight - checking which is bigger and placeing it in
        # if not then it will add to the dict with the weight as key and iteration as value
